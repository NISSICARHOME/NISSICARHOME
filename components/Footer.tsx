    ...
    <footer id="contacto" className="bg-white/20 backdrop-blur-md border-t border-white/30">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-800 uppercase tracking-wider">Nissi Car Home</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-800 uppercase tracking-wider">Contáctanos</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-800 uppercase tracking-wider">Síguenos</h3>
