        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <div className="mt-4 space-y-2 text-sm text-gray-700">
              ...
              <p><strong>Teléfono:</strong> <a href="tel:+573203393805" onClick={() => handleContactClick('Phone')} className="hover:text-amber-500 transition-colors">+57 320 339 3805</a></p>
              <p><strong>Email:</strong> <a href="mailto:nissicarhome.ia@gmail.com" onClick={() => handleContactClick('Email')} className="hover:text-amber-500 transition-colors">nissicarhome.ia@gmail.com</a></p>
