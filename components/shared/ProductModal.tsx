...
const DetailSection: React.FC<{ title: string; children: React.ReactNode; }> = ({ title, children }) => (
    <div className="mt-4">
        <h4 className="text-lg font-semibold text-amber-600 border-b border-gray-400/50 pb-1 mb-2 drop-shadow-golden-glow">{title}</h4>
      ...
      >
        ...
        <div className="p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                ...
                <div>
                     {product.details.content && <p className="text-lg font-bold text-amber-600 drop-shadow-golden-glow">{product.details.content}</p>}
                    {(product.details.features && product.details.features.length > 0) && (
                     ...
                     {(product.details.surfaces && product.details.surfaces.length > 0) && (
                        <div className="mt-4">
                            <h4 className="text-md font-semibold text-amber-600 mb-2 drop-shadow-golden-glow">Superficies de aplicación:</h4>
